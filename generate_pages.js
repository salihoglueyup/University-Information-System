...
const baseDir = "c:/Gelistirme/ubis/client/src/pages/dashboard";
...
const template = (componentName, pageTitle) => `import React from 'react';
...
export default function ${componentName}() {
    return (
        ...
        >
            <h1 className="text-2xl font-bold text-slate-800 mb-4">${pageTitle}</h1>
...
pages.forEach(([componentName, pageTitle]) => {
    const filePath = path.join(baseDir, `${componentName}.jsx`);
    fs.writeFileSync(filePath, template(componentName, pageTitle), 'utf8');
